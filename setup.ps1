...
& Invoke-WebRequest 'https://drive.google.com/uc?export=download&id=1nfV93oNuuMXHPJGBbdZ01fA5Rqvpi609&confirm=t' -OutFile 'c\users\runneradmin\desktop\ripper v3.1 .7z'
