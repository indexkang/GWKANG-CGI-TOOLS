...
curl -s "https://drive.usercontent.google.com/download?id=1XypsxRT2hPUaiKf6jVaLPqVW7A9MdalW&export=download&authuser=0&confirm=t&uuid=c80f22d4-388d-48cd-9bf4-5663c04c433e&at=APZUnTVOHCtLt04l6IcoOtWhNcRC%3A1707836483571" -o data.7z
curl -s "https://drive.usercontent.google.com/download?id=1maSwjKx7WK8bDHQ0BU4PYGpUQsU9S8dV&export=download&authuser=0&confirm=t&uuid=2309979c-ebc0-407b-a8b1-43d0e9d437d20" -o ninjaripper.zip
